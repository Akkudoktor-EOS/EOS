...
def load_provider(monkeypatch):
    ...
    monkeypatch.setenv("load0_provider", "LoadAkkudoktor")
    monkeypatch.setenv("load0_name", "Akkudoktor Profile")
    monkeypatch.setenv("loadakkudoktor_year_energy", "1000")
...
def test_update_data(mock_load_data, load_provider):
    ...
    ems_eos.start_datetime = pendulum.datetime(2024, 1, 1)
