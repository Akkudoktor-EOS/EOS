...
class TestBattery:
    def test_initial_state_of_charge(self, battery_10kw_soc50: Battery):
        assert battery_10kw_soc50.charge_state_percent() == 50.0, "Initial SoC should be 50%"
    ...
    def test_discharge_below_min_soc(self, battery_10kw_soc50: Battery):
        ...
        abgegeben_wh, _ = battery_10kw_soc50.discharge(5000, 0)  # Try to discharge 5000 Wh
        expected_soc = battery_10kw_soc50.min_soc_percent  # SoC should not drop below min_soc
        assert (
            battery_10kw_soc50.charge_state_percent() == expected_soc
        ), "SoC should not drop below min_soc after discharge"
        assert abgegeben_wh == 2640.0, "The energy discharged should be limited by min_soc"
    ...
    def test_charge_above_max_soc(self, battery_10kw_soc50: Battery):
        ...
        assert (
            battery_10kw_soc50.charge_state_percent() <= battery_10kw_soc50.max_soc_percent
    ...
    def test_charging_at_max_soc(self, battery_10kw_soc80: Battery):
        ...
        assert (
            battery_10kw_soc80.charge_state_percent() == battery_10kw_soc80.max_soc_percent
    ...
    def test_discharging_at_min_soc(self, battery_10kw_soc20: Battery):
        ...
        assert (
            battery_10kw_soc20.charge_state_percent() == battery_10kw_soc20.min_soc_percent
    ...
    def test_soc_limits(self, battery_10kw_soc50: Battery):
        ...
        battery_10kw_soc50.soc_wh = min(battery_10kw_soc50.soc_wh, battery_10kw_soc50.max_soc_wh)
        assert (
            battery_10kw_soc50.charge_state_percent() == battery_10kw_soc50.max_soc_percent
        ...
        battery_10kw_soc50.soc_wh = max(battery_10kw_soc50.soc_wh, battery_10kw_soc50.min_soc_wh)
        assert (
            battery_10kw_soc50.charge_state_percent() <= battery_10kw_soc50.min_soc_percent
