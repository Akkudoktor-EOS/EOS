...
def test_simulation(create_ems_instance):
    ...
    assert len(result["battery_soc_per_hour"]) == 47, (
    ...
    assert result["battery_soc_per_hour"][-1] == 42.151590909090906, (
        "The value at index -1 of 'battery_soc_per_hour' should be 42.151590909090906."
    )
    assert result["battery_soc_per_hour"][1] == 60.08659090909091, (
