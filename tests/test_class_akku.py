...
class TestPVAkku:
    ...
    def test_initial_state_of_charge(self):
        ...
        assert akku.ladezustand_in_prozent() == 50.0
    ...
    def test_discharge_below_min_soc(self):
        ...
        assert (
            akku.ladezustand_in_prozent() == expected_soc
    ...
    def test_charging_at_max_soc(self):
        ...
        assert akku.ladezustand_in_prozent() == self.max_soc_prozent, "SoC should remain at max_soc"
    ...
    def test_discharging_at_min_soc(self):
        ...
        assert akku.ladezustand_in_prozent() == self.min_soc_prozent, "SoC should remain at min_soc"
    ...
    def test_soc_limits(self):
        ...
        assert (
            akku.ladezustand_in_prozent() == self.max_soc_prozent
        ...
        assert (
            akku.ladezustand_in_prozent() == self.min_soc_prozent
