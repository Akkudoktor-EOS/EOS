...
class GeneticSolution(GeneticParametersBaseModel):
    ...
    def optimization_solution(self) -> OptimizationSolution:
        ...
        # - load_mean_adjusted_power_w: Adjusted load mean energy prediction in wh
        ...
        if "load_mean" in pred.record_keys:
            prediction["load_mean_energy_wh"] = (
                pred.key_to_array(
                    key="load_mean",
                    start_datetime=start_datetime,
                    end_datetime=end_datetime,
        ...
        if "load_std" in pred.record_keys:
            prediction["load_std_energy_wh"] = (
                pred.key_to_array(
                    key="load_std",
                    start_datetime=start_datetime,
                    end_datetime=end_datetime,
        ...
        if "load_mean_adjusted" in pred.record_keys:
            prediction["load_mean_adjusted_energy_wh"] = (
                pred.key_to_array(
