...
class SimulationResult(GeneticParametersBaseModel):
...
class GeneticSolution(GeneticParametersBaseModel):
    ...
    def energy_management_plan(self) -> EnergyManagementPlan:
        ...
        plan = EnergyManagementPlan(
            ...
            instructions=[],
            comment="Energy management plan derived from genetic GeneticSolution.",
        )
        ...
        if self.eautocharge_hours_float:
        ...
        # Add home appliance instructions ()
