...
class PVForecast:
    ...
    def __init__(
        ...
        self.url = url
        if forecast_start:
            self._forecast_start = to_datetime(forecast_start, to_maxtime=False)
        else:
    ...
    def get_temperature_forecast_for_date(
        ...
        input_date = to_datetime(input_date, to_timezone=self._tz_name).date()
        daily_forecast_obj = [
    ...
    def get_pv_forecast_for_date_range(
        ...
        start_date = to_datetime(start_date, to_timezone=self._tz_name).date()
    ...
    def get_forecast_start(self) -> datetime:
        ...
        if not self._forecast_start:
            return None
        return to_datetime(
            to_datetime(self._forecast_start, to_timezone=self._tz_name), to_maxtime=False
        )
