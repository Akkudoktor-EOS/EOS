...
from akkudoktoreos.config import moegliche_ladestroeme_in_prozent, prediction_hours
...
class optimization_problem:
    ...
    def evaluate(
        ...
        restwert_akku = (
            ems.akku.aktueller_energieinhalt() * parameters.ems.preis_euro_pro_wh_akku
        )
        gesamtbilanz += (
            max(
                0,
