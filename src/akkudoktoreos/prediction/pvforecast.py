...
class PVForecastCommonSettings(SettingsBaseModel):
    ...
    pvforecast0_mountingplace: Optional[str] = Field(
        default="free",
        description="Type of mounting for PV system. Options of 'free' for free-standing and 'building' for building-integrated.",
    )
    ...
    def pvforecast_planes(self) -> List[str]:
        ...
        for i in range(5):  # Assuming pvforecast0 to pvforecast4
