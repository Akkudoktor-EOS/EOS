...
def fastapi_gesamtlast(
    ...
    hours: int = config_eos.prediction_hours if config_eos.prediction_hours else 48,
) -> list[float]:
...
# Keep this last
# Also keep the single endpoints to assure openai.json is always build the same way.
