...
def to_duration(input_value: Union[timedelta, str, int, float, tuple, list]) -> timedelta:
...
def to_timezone(
    ...
    location: Optional[Set[float]] = None,
    ...
    Args:
        ...
        location (Optional[Set[float]]): A set containing latitude and longitude as floats.
