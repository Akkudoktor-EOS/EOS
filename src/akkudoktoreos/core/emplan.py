...
class OMBCSystemDescription(PydanticBaseModel):
...
class FRBCActuatorDescription(PydanticBaseModel):
...
class FRBCStorageDescription(PydanticBaseModel):
...
class DDBCActuatorDescription(PydanticBaseModel):
...
class EnergyManagementPlan(PydanticBaseModel):
    ...
    instructions: list[BaseInstruction] = Field(
    ...
    def add_instruction(self, instruction: BaseInstruction) -> None:
    ...
    def get_active_instructions(self, now: Optional[DateTime] = None) -> list[BaseInstruction]:
    ...
    def get_next_instruction(self, now: Optional[DateTime] = None) -> Optional[BaseInstruction]:
    ...
    def get_instructions_for_resource(self, resource_id: ID) -> list[BaseInstruction]:
