...
class MeasurementCommonSettings(SettingsBaseModel):
    ...
    battery_soc_keys: Optional[list[str]] = Field(
        default=None,
        description="The keys of the measurements that are battery state of charge readings [%].",
        examples=[["battery1_soc"]],
    )

    electric_vehicle_soc_keys: Optional[list[str]] = Field(
        default=None,
        description="The keys of the measurements that are EV battery state of charge readings [%].",
        examples=[["battery1_soc"]],
    )
