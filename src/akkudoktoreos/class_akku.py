...
class PVAkku:
    def __init__(self, parameters: PVAkkuParameters, hours: int = 24):
        ...
        self.max_ladeleistung_w = (
            parameters.max_ladeleistung_w
            if parameters.max_ladeleistung_w
            else self.kapazitaet_wh
        )
        self.min_soc_prozent = parameters.min_soc_prozent
