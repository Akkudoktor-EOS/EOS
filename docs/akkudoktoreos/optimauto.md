...
The predictions may rely on past measurements to more exactly forecast behaviour. E.g. the load
forecast needs past load energy meter readings.

Configure the [measurement](#measurement-page) as described on the [measurement page](#measurement-page).
